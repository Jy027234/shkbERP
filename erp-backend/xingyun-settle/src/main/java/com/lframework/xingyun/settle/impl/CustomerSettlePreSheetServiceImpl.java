...
public class CustomerSettlePreSheetServiceImpl extends
  ...
  @OpLog(type = SettleOpLogType.SETTLE, name = "创建客户预付款单，单号：{}", params = "#code")
  ...
  @OpLog(type = SettleOpLogType.SETTLE, name = "修改客户预付款单，单号：{}", params = "#code")
  ...
  @OpLog(type = SettleOpLogType.SETTLE, name = "审核通过客户预付款单，单号：{}", params = "#code")
  ...
  @OpLog(type = SettleOpLogType.SETTLE, name = "审核拒绝客户预付款单，单号：{}", params = "#code")
