...
public class QueryProductStockBatchBo extends BaseBo<ProductStockBatch> {
    ...
    public QueryProductStockBatchBo() {

    }

    public QueryProductStockBatchBo(ProductStockBatch dto) {
