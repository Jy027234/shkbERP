...
<table>
    ...
    <tr height="24" style="height:14.40pt;">
        ...
        <td colspan="7" class="et2" x:str="" style="border-width: 1px; border-style: solid;">
            航材名称
        </td>
        <td class="et2" x:str="" style="border-width: 1px; border-style: solid;">
            采购价
    ...
    <tr height="24" style="height:14.40pt;">
        ...
        <td colspan="7" class="et6" style="border-width: 1px; border-style: solid; border-right-color: rgb(0, 0, 0);">${detail.productName!''}</td>
