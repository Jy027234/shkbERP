...
@ApiModel(value="\u521b\u5efa\u5458\u5de5\u8bc1\u4e66\u8bf7\u6c42\u53c2\u6570")
public class CreateShkbEmployeeCertificateVo {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateShkbEmployeeCertificateVo)) {
            return false;
        }
        CreateShkbEmployeeCertificateVo other = (CreateShkbEmployeeCertificateVo)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof CreateShkbEmployeeCertificateVo;
    }
