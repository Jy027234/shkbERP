 ...
 */
@Data
public class GetWorkCardBo extends BaseBo<WorkCard> {
    ...
    public GetWorkCardBo() {
    }

    public GetWorkCardBo(WorkCard dto) {
        super(dto);
    }
    ...
    protected void afterInit(WorkCard dto) {
        // 不需要在这里查询数据库
        // 因为在 WorkCardMapper.xml 的 getDetail 方法中已经通过关联查询获取了这些字段
