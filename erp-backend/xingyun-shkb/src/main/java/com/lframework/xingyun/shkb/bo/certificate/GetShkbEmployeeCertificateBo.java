...
public class GetShkbEmployeeCertificateBo
implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetShkbEmployeeCertificateBo)) {
            return false;
        }
        GetShkbEmployeeCertificateBo other = (GetShkbEmployeeCertificateBo)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof GetShkbEmployeeCertificateBo;
    }
