...
@Data
public class QueryToolRecordBo extends BaseBo<ShkbToolRecord> {
    ...
    private List<ToolRecordFileBo> attachments;

    public QueryToolRecordBo() {
    }

    public QueryToolRecordBo(ShkbToolRecord dto) {
        super(dto);
    }
}
