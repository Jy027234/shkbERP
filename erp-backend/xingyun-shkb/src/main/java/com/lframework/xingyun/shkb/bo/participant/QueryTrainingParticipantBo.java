...
public class QueryTrainingParticipantBo
implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof QueryTrainingParticipantBo)) {
            return false;
        }
        QueryTrainingParticipantBo other = (QueryTrainingParticipantBo)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof QueryTrainingParticipantBo;
    }
