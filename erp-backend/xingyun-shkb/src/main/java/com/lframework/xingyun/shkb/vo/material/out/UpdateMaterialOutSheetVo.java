 ...
 */
@Data
public class UpdateMaterialOutSheetVo implements BaseVo, Serializable {
    ...
    private List<UpdateMaterialOutSheetDetailVo> details;

    @Data
    public static class UpdateMaterialOutSheetDetailVo implements BaseVo, Serializable {
    ...
    public void validate() {
        // 基本验证逻辑
        if (details != null) {
            for (UpdateMaterialOutSheetDetailVo detail : details) {
