...
@ApiModel(value="\u4fee\u6539\u5458\u5de5\u57f9\u8bad\u8bb0\u5f55\u8bf7\u6c42\u53c2\u6570")
public class UpdateShkbEmployeeTrainingVo {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateShkbEmployeeTrainingVo)) {
            return false;
        }
        UpdateShkbEmployeeTrainingVo other = (UpdateShkbEmployeeTrainingVo)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof UpdateShkbEmployeeTrainingVo;
    }
