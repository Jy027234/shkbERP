...
@ApiModel(value="\u521b\u5efa\u57f9\u8bad\u8bfe\u7a0b\u8bf7\u6c42\u53c2\u6570")
public class CreateShkbTrainingCourseVo {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateShkbTrainingCourseVo)) {
            return false;
        }
        CreateShkbTrainingCourseVo other = (CreateShkbTrainingCourseVo)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof CreateShkbTrainingCourseVo;
    }
