...
public class GetShkbEmployeeTrainingBo
implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetShkbEmployeeTrainingBo)) {
            return false;
        }
        GetShkbEmployeeTrainingBo other = (GetShkbEmployeeTrainingBo)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof GetShkbEmployeeTrainingBo;
    }
