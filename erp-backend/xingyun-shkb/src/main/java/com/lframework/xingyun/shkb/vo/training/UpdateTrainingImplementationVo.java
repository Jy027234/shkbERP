...
public class UpdateTrainingImplementationVo {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateTrainingImplementationVo)) {
            return false;
        }
        UpdateTrainingImplementationVo other = (UpdateTrainingImplementationVo)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof UpdateTrainingImplementationVo;
    }
    ...
    public String toString() {
        return "UpdateTrainingImplementationVo(id=" + this.getId() + ", courseId=" + this.getCourseId() + ", planStartDate=" + this.getPlanStartDate() + ", planEndDate=" + this.getPlanEndDate() + ", trainingLocation=" + this.getTrainingLocation() + ", instructor=" + this.getInstructor() + ", description=" + this.getDescription() + ")";
    }
}
