...
export const ShkbRoute: AppRouteRecordRaw = {
  path: '/shkb',
  name: 'ShkbRoute',
  component: LAYOUT,
  meta: { title: '凯奔定制' },
  children: [
    {
      ...
      component: () => import('/@/views/product-storage/index.vue'),
      meta: {
        title: '成品库',
      },
    },
...
// 未经许可的基本路由
export const WorkCardRoute: AppRouteRecordRaw = {
  path: '/work-card',
  name: 'WorkCardRoute',
  component: LAYOUT,
  meta: { title: '工卡管理' },
  children: [
    {
      ...
      component: () => import('/@/views/work-card/product/index.vue'),
      meta: {
        title: '工卡必换件管理',
        hideMenu: true,
      },
...
export const MaterialRoute: AppRouteRecordRaw = {
  path: '/material',
  name: 'MaterialRoute',
  component: LAYOUT,
  meta: { title: '航材业务' },
  children: [
    {
      ...
      component: () => import('/@/views/material/out/add.vue'),
      meta: {
        title: '新增发料出库单',
      },
    },
    {
      ...
      component: () => import('/@/views/material/out/modify.vue'),
    },
    {
      path: 'out/approve/:id',
      ...
      component: () => import('/@/views/material/out/approve.vue'),
    },
  ],
};
