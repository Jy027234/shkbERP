<template>
  <a-tree-select v-bind="getAttrs" @change="handleChange" :field-names="fieldNames">
    <template #[item]="data" v-for="item in forwardedSlotNames" :key="item">
  ...
  export default defineComponent({
    ...
    setup(props, { attrs, emit, slots }) {
      ...
      type TreeSelectSlotName =
        ...
        | 'tagRender'
        | 'suffixIcon';
      const forwardedSlotNames = computed(() => Object.keys(slots) as TreeSelectSlotName[]);
      ...
      return { getAttrs, loading, handleChange, fieldNames, forwardedSlotNames };
    },
  });
</script>
