      ...
      <template #form>
        ...
        <j-border>
          <j-form>
            ...
            <j-form-item v-if="$utils.isEmpty(requestParams.mnemonicCode)" label="简码">
              <a-input v-model:value="searchParams.mnemonicCode" />
            </j-form-item>
      ...
      tableColumn: {
        ...
        default: () => {
          return [
            ...
            { field: 'mnemonicCode', title: '简码', width: 120 },
            {
              field: 'available',
              title: '状态',
              width: 80,
