        ...
        <j-border>
          <j-form>
            ...
            <j-form-item v-if="$utils.isEmpty(requestParams.machineTypeId)" label="机型">
              <machine-type-selector v-model:value="searchParams.machineTypeId" />
            </j-form-item>
...
<script>
  ...
  import MachineTypeSelector from './MachineTypeSelector.vue';

  export default defineComponent({
    name: 'PartNumberSelector',
    components: { SearchOutlined, MachineTypeSelector },
    props: {
      requestParams: {
        type: Object,
        default: () => {
