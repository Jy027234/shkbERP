 ...
 * @returns 附件列表
 */
export function getToolAttachments(toolId: string) {
  return defHttp.get(
    {
 ...
 * @returns 上传结果
 */
export function uploadToolAttachments(toolId: string, files: File[]) {
 ...
 * @returns 删除结果
 */
export function deleteToolAttachment(id: string) {
 ...
 * @returns 删除结果
 */
export function batchDeleteToolAttachments(ids: string[]) {
  return defHttp.delete(
    {
