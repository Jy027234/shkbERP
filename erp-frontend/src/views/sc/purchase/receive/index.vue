            ...
            <j-border>
              <j-form @collapse="$refs.grid.refreshColumn()">
                ...
                <template #more>
                  ...
                  <j-form-item v-show="false" label="结算状态">
                    <a-select
    ...
    data() {
      return {
        ...
        tableColumn: [
          ...
          { field: 'totalNum', title: '航材数量', align: 'right', width: 120 },
          { field: 'totalGiftNum', title: '赠品数量', align: 'right', width: 120, visible: false },
