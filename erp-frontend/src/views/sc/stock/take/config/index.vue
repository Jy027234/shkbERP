      ...
      <a-row>
        <a-col :md="16" :sm="24">
          <a-card v-loading="loading">
            ...
            >
              <a-form-item
                label="库存盘点单关联盘点任务后，是否显示盘点任务中的航材数据"
                name="showProduct"
              >
              ...
              <a-form-item
                label="库存盘点单是否显示盘点任务创建时航材的系统库存数量"
                name="showStock"
              >
              ...
              <a-form-item
                label="盘点差异生成时是否自动调整盘点任务中航材的系统库存数量"
      ...
      return {
        ...
        rules: {
          showProduct: [
            {
              required: true,
              message: '请选择库存盘点单关联盘点任务后，是否显示盘点任务中的航材数据',
            },
          ],
          showStock: [
            { required: true, message: '请选择库存盘点单是否显示盘点任务创建时航材的系统库存数量' },
          ],
          autoChangeStock: [
            {
              required: true,
              message: '请选择盘点差异生成时是否自动调整盘点任务中航材的系统库存数量',
            },
          ],
          allowChangeNum: [
