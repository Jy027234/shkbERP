    ...
    data() {
      return {
        ...
        batchColumns: [
          ...
          { title: '调拨数量', dataIndex: 'transferNum', width: 100, align: 'right' },
          { title: '已收货数量', dataIndex: 'receivedNum', width: 100, align: 'right' },
        ...
        serialColumns: [
          ...
          { title: '调拨状态', dataIndex: 'transferStatusText', width: 100 },
          { title: '备注', dataIndex: 'description', width: 200 },
        ],
      };
    },
              ...
              Object.assign(
                {
                  ...
                  productCode: detail.productCode,
                  transferStatusText: Number(item.transferStatus) === 1 ? '在途' : '已收货',
                },
                item,
              ),
            );
