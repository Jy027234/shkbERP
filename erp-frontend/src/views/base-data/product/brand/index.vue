<template>
  <div v-permission="['base-data:product:brand:query']">
        ...
        <template #form>
          <j-border>
            <j-form label-width="80px" @collapse="$refs.grid.refreshColumn()">
              <j-form-item v-if="false" label="编号">
    ...
    <batch-handler
      ...
      :table-column="[
        { field: 'code', title: '编号', width: 100, visible: false },
    ...
    data() {
      return {
        ...
        tableColumn: [
          ...
          { field: 'code', title: '编号', width: 120, sortable: true, visible: false },
    ...
    methods: {
      ...
      batchUnable() {
        ...
        if (this.$utils.isEmpty(records)) {
          this.$msg.createError('请选择要停用的制造商！');
          return;
        }
      ...
      batchEnable() {
        ...
        if (this.$utils.isEmpty(records)) {
          this.$msg.createError('请选择要启用的制造商！');
          return;
        }
